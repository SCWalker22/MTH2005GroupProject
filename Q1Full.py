...
def part_a():
    ...
    plt.ylabel("Droplet Radius (μm)", fontsize=14)
    plt.title("Cloud Droplet Growth (T=283K, s=0.30%)", fontsize=20)
    plt.legend()
    plt.grid()
    ...
    plt.title("Forward Euler with Analytical Solution", fontsize=20)
    plt.xlabel("Time (minutes)", fontsize=14)
    plt.ylabel("Droplet Radius (μm)", fontsize=14)
    plt.legend()
    plt.grid()
...
def part_d():
    ...
    plt.ylabel("Time taken to reach precipitation size (days)", fontsize=14)
    ...
    plt.xlabel("Temperature (K)", fontsize=14)
    plt.ylabel("Time taken to reach drizzle size (hours)", fontsize=14)
    plt.grid()
    plt.show()
...
def part_e():
    ...
    plt.xlim(t_min, t_max)
    plt.xlabel("Temperature (K)", fontsize=14)
    plt.ylabel("Time taken to evaporate completely (s)", fontsize=14)
